 ...
 */
namespace Aitoc\TwoFactorAuthentication\Block\User\Tab;
...
class TfaSettings extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            'select',
            [
                'name' => "aitoc_tfa[".$extUser::EMAIL_CODE_ENABLED."]",
        ...
        $toggle = $fieldset->addField(
            ...
            'select',
            [
                'name' => "aitoc_tfa[".$extUser::IS_ACTIVE."]",
        ...
        $fieldset->addField(
            ...
            'select',
            [
                'name' => "aitoc_tfa[".$extUser::TIME_SHIFT."]",
        ...
        if ($extUser->getIsActive()) {
            ...
            $formData->setData("aitoc_tfa_update", 1);
        }
        ...
        $fieldset->addField(
            ...
            'hidden',
            [
                'name' => "aitoc_tfa[".$extUser::USER_SECRET."]"
            ]
        );

...
define([
    ...
    /**
     * Check whether the incoming string is empty or only spaces.
     *
     * @param {String} value
     * @returns {Boolean}
     */
    ...
    $.widget('mage.quickSearch', {
        ...
        _create: function () {
            ...
            this.submitBtn = this.searchForm.find(this.options.submitBtn).get(0) || null;
        ...
        /**
         * Executes when keys are pressed in the search input field.
         *
         * @private
         * @param {Event} e
        ...
        _onKeyDown: function (e) {
            ...
            switch (keyCode) {
                ...
                case $.ui.keyCode.UP:
                    if (this.responseList.indexList !== null && this.responseList.selected) {
            ...
            if (value.length >= parseInt(this.options.minSearchLength, 10)) {
                $.getJSON(this.options.url, {
                    ...
                    if (data.length) {
                        ...
                        this._updateAriaHasPopup(!!this.responseList.indexList.length);
